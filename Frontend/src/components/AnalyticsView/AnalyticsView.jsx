...
const SUB_TABS = [
  ...
  { id: 'lending', label: 'Lending Portfolio', icon: HandCoins },
  { id: 'borrowing', label: 'Borrowing Obligations', icon: Landmark },
  { id: 'payments', label: 'Payments & Cash Flow', icon: CreditCard },
  { id: 'overdue', label: 'Overdue & Risk', icon: Hourglass },
  { id: 'people', label: 'Counterparty Matrix', icon: Users },
  { id: 'currency', label: 'Currency & Interest', icon: Coins },
